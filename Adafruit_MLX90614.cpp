// adafruit library edited to allow selection of different I2C addresses
// (multiple temp sensors)
// default address is 0x5A, alternative addresses include 0x55 and 0x50, etc.
...
Adafruit_MLX90614::Adafruit_MLX90614(uint8_t alt_addr) {
  _addr = alt_addr;
}
